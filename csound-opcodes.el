...
(puthash "miditempo" '(:template "ksig miditempo" :doc "Returns the current tempo at k-rate, of either the MIDI file (if available) or the score") csdoc-opcode-database)
...
(puthash "tableiw" '(:template "tableiw isig, indx, ifn [, ixmode] [, ixoff] [, iwgmode]" :doc "Change the contents of existing function tables.") csdoc-opcode-database)
...
ival1, [ival2, ... , ival31] pop" :doc "Pops values from the global stack.  Deprecated.") csdoc-opcode-database)
...
(puthash "vstnote" '(:template "vstnote instance, kchan, knote, kveloc, kdur" :doc "Sends a MIDI note with definite duration to a VST plugin.") csdoc-opcode-database)
...
(puthash "setrow" '(:template "kout[] setrowkin[],krow" :doc "Sets a given row of a 2-dimensional array from a vector.") csdoc-opcode-database)
...
(puthash "OSClisten" '(:template "kans OSClisten ihandle, idest, itype [, xdata1, xdata2, ...]" :doc "Listen for OSC messages to a particular path.") csdoc-opcode-database)
...
(puthash "fluidEngine" '(:template "ienginenum fluidEngine [iReverbEnabled] [, iChorusEnabled] [,iNumChannels] [, iPolyphony]" :doc "Instantiates a fluidsynth engine.") csdoc-opcode-database)
...
(puthash "vstedit" '(:template "vstedit instance" :doc "Opens the GUI editor window for a VST plugin.") csdoc-opcode-database)
...
(puthash "faustcompile" '(:template "ihandle faustcompile Scode, Sargs" :doc "Invokes the just-in-time compiler to produce a instantiable DSP process from a Faust program.") csdoc-opcode-database)
...
(puthash "soundouts" '(:template "soundouts asigl, asigr, ifilcod [, iformat]" :doc "Deprecated. Writes audio output to a disk file.") csdoc-opcode-database)
...
(puthash "vstbankload" '(:template "vstbankload instance, ipath" :doc "Loads parameter banks to a VST plugin.") csdoc-opcode-database)
...
(puthash "fluidControl" '(:template "fluidControl ienginenum, kstatus, kchannel, kdata1, kdata2" :doc "Sends MIDI note on, note off, and other messages to a SoundFont preset.") csdoc-opcode-database)
...
karray fillarray ival1, ival2,.....ivaln" :doc "Generate a vector with initial values.") csdoc-opcode-database)
...
(puthash "push_f" '(:template "push_f fsig" :doc "Pushes an f-sig frame into the global stack.  Deprecated.") csdoc-opcode-database)
...
(puthash "lowres" '(:template "ares lowres asig, kcutoff, kresonance [, iskip]" :doc "Another resonant lowpass filter.") csdoc-opcode-database)
(puthash "lua_exec" '(:template "lua_exec Sluacode" :doc "Executes an arbitrary block of Lua code from the Csound orchestra.") csdoc-opcode-database)
...
(puthash "filevalid" '(:template "ir filevalid ifilcod" :doc "Checks that a file can be used.") csdoc-opcode-database)
...
(puthash "printk" '(:template "printk itime, kval [, ispace]" :doc "Prints one k-rate value at specified intervals.") csdoc-opcode-database)
...
(puthash "loscilx" '(:template "ar1 [, ar2, ar3, ar4, ar5, ar6, ar7, ar8, ar9, ar10, ar11, ar12, ar13, ar14, ar15, ar16] loscilx xamp, kcps, ifn [, iwsize, ibas, istrt, imod, ibeg, iend]" :doc "Read multi-channel sampled sound from a table.") csdoc-opcode-database)
...
kvalue vstparamget instance, kparam" :doc "Used for parameter comunication to and from a VST plugin.") csdoc-opcode-database)
...
(puthash "vstinit" '(:template "instance vstinit ilibrarypath [,iverbose]" :doc "Load a VST plugin into memory for use with the other vst4cs opcodes.") csdoc-opcode-database)
...
(puthash "getcol" '(:template "kout[] getcolkin[],kcol" :doc "Gets a given column from a 2-dimensional array as a vector.") csdoc-opcode-database)
...
(puthash "pvscent" '(:template "kcent pvscent fsig" :doc "Calculate the spectral centroid of a signal.") csdoc-opcode-database)
...
push ival1, [ival2, ... , ival31]" :doc "Pushes a value into the global stack.  Deprecated.") csdoc-opcode-database)
...
aout1,aout2 vstaudiog instance, [ain1, ain2]" :doc "VST audio output.") csdoc-opcode-database)
...
(puthash "lua_opdef" '(:template "lua_opdef Sname, Sluacode" :doc "Define an opcode in Lua at i-rate. The opcode can take any 
             number of output and/or input arguments of any type.") csdoc-opcode-database)
...
(puthash "loscil" '(:template "ar1 [,ar2] loscil xamp, kcps, ifn [, ibas] [, imod1] [, ibeg1] [, iend1] [, imod2] [, ibeg2] [, iend2]" :doc "Read sampled sound from a table.") csdoc-opcode-database)
...
(puthash "vstmidiout" '(:template "vstmidiout instance, kstatus, kchan, kdata1, kdata2" :doc "Sends MIDI information to a VST plugin.") csdoc-opcode-database)
